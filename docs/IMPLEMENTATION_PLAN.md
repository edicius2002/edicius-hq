...
| 8.32 | The sidebar scrolls **within itself**.                                                                                     | Ten followed symbols and seven positions are taller than a viewport, and scrolling the page to reach the positions carried the chart off screen — which is the one thing having both on one screen was for. Sticky and capped to the viewport; stacked below 1100px it goes back to normal flow, where a private scroll area would be a box inside a box.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| 2026-08-07 | INV-05 delivered (#49): positions, P&L against live quotes, seven legacy holdings migrated (8.29–8.32).             |
